...
Now edit the `src\main\java\com\redhat\developers\GreetingResource.java` class like this:
...
Edit your Containerfile like this (or simply add the `ENV config=containerfile` line):
